...
{
    public class SajDsgPostgreSqlMigrationsDbContext : MigrationsDbContext
    {
        private readonly string _connectionString;

        public SajDsgPostgreSqlMigrationsDbContext()
        {
            _connectionString = ConfigDbContext.LOCAL_DSG_CONNECTION_STRING_POSTGRES;
        }

        public SajDsgPostgreSqlMigrationsDbContext(string connectionString)
        {
