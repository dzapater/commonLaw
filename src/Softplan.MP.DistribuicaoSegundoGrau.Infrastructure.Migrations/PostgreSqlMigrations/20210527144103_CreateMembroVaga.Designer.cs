...
namespace Softplan.MP.DistribuicaoSegundoGrau.Infrastructure.Migrations.PostgreSqlMigrations
{
    ...
    [Migration("20210527144103_CreateMembroVaga")]
    partial class CreateMembroVaga
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Softplan.MP.DistribuicaoSegundoGrau.Domain.Cadastros.VinculoMembroVagas.MotivoMembroVaga", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_motivo_membro_vaga");

                    b.ToTable("motivo_membro_vaga");
                });
            ...
            modelBuilder.Entity("Softplan.MP.DistribuicaoSegundoGrau.Domain.Cadastros.VinculoMembroVagas.VinculoMembroVaga", b =>
                {
                    ...
                    b.HasIndex("IdMotivoMembroVaga")
                        .HasName("ix_membro_vaga_id_motivo_membro_vaga");
            ...
            modelBuilder.Entity("Softplan.MP.DistribuicaoSegundoGrau.Domain.Cadastros.VinculoMembroVagas.MotivoMembroVaga", b =>
                {
                    b.OwnsOne("Softplan.Common.Core.Entities.EntityMetadata", "Metadata", b1 =>
                        {
                            b1.Property<int>("MotivoMembroVagaId")
                                .ValueGeneratedOnAdd()
                                .HasColumnName("id")
                                .HasColumnType("integer")
                                .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                            ...
                            b1.HasKey("MotivoMembroVagaId")
                                .HasName("pk_motivo_membro_vaga");

                            b1.HasIndex("Uuid")
                                .IsUnique()
                                .HasName("ix_motivo_membro_vaga_metadata_uuid");

                            b1.ToTable("motivo_membro_vaga");

                            b1.WithOwner()
                                .HasForeignKey("MotivoMembroVagaId")
                                .HasConstraintName("fk_motivo_membro_vaga_motivo_membro_vaga_id");
                        });
                });

            modelBuilder.Entity("Softplan.MP.DistribuicaoSegundoGrau.Domain.Cadastros.VinculoMembroVagas.VinculoMembroVaga", b =>
                {
                    b.HasOne("Softplan.MP.DistribuicaoSegundoGrau.Domain.Cadastros.VinculoMembroVagas.MotivoMembroVaga", "MotivoMembroVaga")
                        .WithMany()
                        .HasForeignKey("IdMotivoMembroVaga")
                        .HasConstraintName("fk_membro_vaga_motivo_membro_vaga_id_motivo_membro_vaga")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
